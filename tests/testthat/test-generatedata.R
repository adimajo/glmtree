...
test_that("generateData in tree scenario", {
  ...
  expect_equal(class(tree_data$x2), "num")
  expect_equal(class(tree_data$x3), "num")
  expect_equal(class(tree_data$y), "num")
  expect_equal(class(tree_data$c), "num ")
})
...
test_that("generateData in no tree scenario", {
  ...
  expect_equal(class(tree_data$x1), "num")
  expect_equal(class(tree_data$x2), "num")
  expect_equal(class(tree_data$y), "num")
})
