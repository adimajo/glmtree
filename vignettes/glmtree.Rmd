...
library(glmtree)
data = generateData(n = 1000, scenario = "no tree", visualize = T)
...
```{r segmentation_glmtree1, warning=F}
...
data = generateData(n = 1000, scenario = "tree", visualize = T)
...
```{r segmentation_glmtree2, warning=F}
